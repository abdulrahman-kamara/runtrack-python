...
class Bibliotheque:
    def __init__(self, nom, catalog):
        self.nom = nom
        self.catalog = catalog
        self.acheterLivre = []

    def acheterLivre(self):
       if(len(self.acheterLivre) == 0):
           print(self.acheterLivre.titre[1] + self.nom)

CL = Client('morris', 'kunda')
B = Bibliotheque('praises', '2')

B.acheterLivre('pretty book')
